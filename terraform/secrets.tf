...
# DISABLED: Causing Helm release name conflict
...
# DISABLED: Causing "cannot re-use a name that is still in use" error
# If you need sealed-secrets, manually import the existing release:
#   terraform import helm_release.sealed_secrets secrets/sealed-secrets
# Or manually delete the existing release first:
#   helm delete sealed-secrets -n secrets
#
...
# DISABLED: sealed-secrets resource is commented out
